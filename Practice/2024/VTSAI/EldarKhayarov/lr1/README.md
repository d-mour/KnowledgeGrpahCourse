...
[Ссылка на код](./RL_№1.ipynb)

## Вывод

В ходе работы, было продемонстрировано применение библиотек для работы с OpenAI Gym, обучение модели на примере LunarLander-v2, а также визуализация результатов обучения.
...
2. **Настройка окружения.**
 ...
 - Создано окружение для LunarLander-v2.
 - Извлечено пространство наблюдения,действий для обучения.
3. **Обучение.**
 - Обучение модели с помощью алгоритма DQN на среде LunarLander-v2. Обучение происходило на заданном количества временных шагов и результаты были сохранены.
4. **Визуализация.**
