...
### Вывод
В результате выполнения лабораторной работы было продемонстрировано использование библиотек для работы с окружением Gymnasium. Было проведено обучение модели на задачe FrozenLake-v1, код написан в среде Jupyter Notebook.
